namespace Modbus.IO
{
    ...
    public abstract class ModbusTransport : IDisposable
    {
        ...
        //internal ModbusTransport(IAsyncStreamResource asyncStreamResource)
        //{
        //    Debug.Assert(asyncStreamResource != null, "Argument asyncStreamResource cannot be null.");

        //    _asyncStreamResource = asyncStreamResource;
        //}
