...
namespace Modbus.IO
{
    ...
    public abstract class ModbusAsyncTransport : IDisposable
    {
        ...
        private IAsyncStreamResource _streamResource;

        /// <summary>
        ///     This constructor is called by the NullTransport.
        /// </summary>
        internal ModbusAsyncTransport()
        {
        }
        ...
        /// </summary>
        internal IAsyncStreamResource StreamResource
        {
        ...
        internal virtual T UnicastMessageAsync<T>(IModbusMessage message)
        ...
        internal abstract Task<IModbusMessage> ReadResponseAsync<T>()
            where T : IModbusMessage, new();
